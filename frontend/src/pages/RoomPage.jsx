...
const RoomComponent = () => {
  ...
  return (
    <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-4 bg-gray-900 min-h-screen">
      <InviteModal />
      <div className="mb-4 sm:mb-4">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-white mb-2 sm:mb-4 flex items-center gap-3">
          <PanelRightIcon className="w-6 h-6 sm:w-8 sm:h-8 text-purple-400" />
          Your Rooms
        </h1>
        <p className="text-gray-400 text-sm sm:text-base">
          Explore and manage your collaborative spaces
        </p>
      </div>

      {rooms.length === 0 ? (
        <div className="text-center py-10 sm:py-16 bg-gray-800 rounded-lg w-full sm:w-1/2 mx-auto">
          <h2 className="text-lg sm:text-2xl font-semibold text-white mb-2 sm:mb-4">
            No Rooms Yet
          </h2>
          <p className="text-gray-400 mb-4 sm:mb-6 text-sm sm:text-base">
            Start collaborating by creating or joining a room
          </p>
        </div>
      ) : (
              ...
              <CardHeader className="pb-1 sm:pb-2">
                <CardTitle className="flex justify-between items-center">
                  ...
                  {room.isPublic ? (
                    <Badge
                      variant="outline"
                      className="text-green-400 border-green-400 text-xs sm:text-base"
                    >
                    ...
                    <Badge
                      variant="outline"
                      className="text-purple-400 border-purple-400 text-xs sm:text-base"
                    >
                ...
                <div className="space-y-1 sm:space-y-2">
                  <div className="flex items-center text-gray-400 text-xs sm:text-base">
                    ...
                    {room.members?.length === room.maxMembers && (
                      <Badge
                        variant="secondary"
                        className="ml-1 sm:ml-2 bg-red-900/20 text-red-400 text-xs sm:text-base"
                      >
                        Full
                      </Badge>
                    )}
