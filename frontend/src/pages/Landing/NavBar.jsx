...
const Header = ({ isScrolled }) => {
    ...
    return (
        <>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 sm:gap-3">
                            <div className="relative h-6 w-6 sm:h-8 sm:w-8">
                                ...
                                />
                                <div
                                    className="absolute inset-0 bg-purple-400/20 rounded-full blur-xl animate-pulse"
                                />
                            </div>
                            <a
                                href="/"
            ...
            <div
                className={`fixed inset-0 bg-black/50 backdrop-blur-sm z-40 transition-opacity duration-300 md:hidden ${isMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
                    }`}
            ...
            {/* Mobile Slide Menu */}
            <div
                className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-[#0A0F23]/95 backdrop-blur-xl border-l border-purple-900/30 z-50 transform transition-transform duration-300 ease-in-out md:hidden ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                <div className="p-6">
                    {/* Close Button */}
...
const DeveloperResources = () => (
    <section id="docs" className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-b from-[#141B3F] to-[#0A0F23]">
...
const About = () => (
    <section id="about" className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-b from-[#121831] to-[#141B3F]">
                    ...
                    <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-purple-500/20">
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg sm:text-xl font-bold text-purple-300">Unified Progress Tracking</h3>
                                    <p className="text-gray-400 text-sm sm:text-base">Monitor growth across all platforms</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg sm:text-xl font-bold text-blue-300">Community Collaboration</h3>
                                    <p className="text-gray-400 text-sm sm:text-base">Connect with like-minded developers</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg sm:text-xl font-bold text-cyan-300">Current Standings</h3>
                                    <p className="text-gray-400 text-sm sm:text-base">Leaderboards and statistics</p>
                                </div>
                            </div>
                        </div>
                    </div>
