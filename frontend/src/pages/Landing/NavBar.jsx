...
import { Code, BadgeInfo } from 'lucide-react';
    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-500 bg-[#0A0F23]/90 backdrop-blur-md shadow-2xl shadow-purple-900/20 px-6 py-4`}>
        <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <Link to="/" className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                    CForge
                </Link>
            </div>
    ...
    <footer className="bg-[#0A0F23]/90 backdrop-blur-md py-10 px-6 border-t border-purple-900/20">
        <div className="container mx-auto text-center text-gray-400 text-md">
            <div className="flex justify-center ">
                <Link
                    to="/about"
                    className="text-gray-400 hover:text-purple-400 hover:scale-102 transition-all duration-300 flex items-center gap-2 "
                    aria-label="Learn more about CForge"
                >
                    <BadgeInfo className="h-4 w-4 text-purple-400" />About CForge
                </Link>
            </div>
