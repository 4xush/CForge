        ...
        <section className="min-h-[98vh] flex items-center justify-center relative overflow-hidden pt-20 px-4">
            ...
            >
                <div className="relative inline-block">
                    <h1 className="text-[80px] sm:text-[120px] md:text-[160px] lg:text-[200px] font-extrabold tracking-tight select-none cursor-pointer leading-none"
                        style={{
                    ...
                    <h1 className="text-[80px] sm:text-[120px] md:text-[160px] lg:text-[200px] font-extrabold tracking-tight absolute top-0 left-0 w-full text-center pointer-events-none select-none leading-none"
                        style={{
                            WebkitTextFillColor: 'transparent',
                ...
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-300 mb-6 max-w-3xl mx-auto font-light tracking-wide mt-4 sm:mt-6 px-4">
            ...
            <div
                ...
                style={{
                    background: 'radial-gradient(circle, rgba(147, 51, 234, 0.1) 0%, rgba(0, 0, 0, 0.9) 100%)',
