            ...
            <div className="bg-gray-800 rounded-xl p-4 sm:p-6 max-w-xs sm:max-w-md w-full mx-2 sm:mx-4 border border-gray-700 shadow-xl">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-lg sm:text-xl font-bold text-white">Verify Your Platform Usernames</h2>
                    </div>
                    <button
                        onClick={onClose}
                    ...
                    {Object.entries(platformUsernames).map(([platform, username]) => (
                        ...
                        >
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <div>
                                    <p className="text-white font-medium capitalize text-xs sm:text-base">{platform}</p>
        ...
        return (
            <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-900 to-purple">
                <div className="flex flex-col items-center gap-3 sm:gap-4">
                    ...
                    <p className="text-gray-300 font-medium text-sm sm:text-base">Loading profile data...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-900 to-purple">
                <div className="bg-gray-800 border border-gray-700 rounded-xl p-4 sm:p-8 max-w-xs sm:max-w-lg text-center">
                    <div className="text-gray-300 text-lg sm:text-xl font-bold mb-2 sm:mb-4">Authentication Required</div>
                    <p className="text-gray-400 text-xs sm:text-base">Please log in to view your profile.</p>
                    <button
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-purple">
            ...
            <div className="max-w-7xl mx-auto p-2 sm:p-4 md:p-8">
                ...
                <div className="mt-4 sm:mt-8 mb-3 sm:mb-6">
                    <h1 className="text-2xl sm:text-3xl font-bold text-white">Welcome, {user.fullName}!</h1>
                                        ...
                                        {heatmapLoading ? (
                                            <div className="flex justify-center items-center h-24 sm:h-32">
                                                <div className="flex flex-col items-center gap-2 sm:gap-4">
                                                    ...
                                                    <p className="text-gray-300 font-medium text-xs sm:text-base">Loading {platform} activity...</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex justify-center items-center h-24 sm:h-32">
                                                <p className="text-gray-400 text-xs sm:text-base">No activity data available for {platform}.</p>
                                            </div>
                                        )}
                                    </HeatmapErrorBoundary>
                                </div>
