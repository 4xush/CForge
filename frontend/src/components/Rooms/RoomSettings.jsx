            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md bg-gray-700 border ${
                    errors.maxMembers ? "border-red-500" : "border-gray-600"
                  } text-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500`}
                />
                {errors.maxMembers && (
              ...
              <button
                type="submit"
                className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-200 font-medium"
              >
