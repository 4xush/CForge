      ...
      <div className="bg-gray-800 rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 space-y-4">
          ...
          <p className="text-gray-400 text-sm">
            Choose when you want to be reminded to review this problem. Regular
            reviews help maintain problem-solving skills.
          </p>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                ...
                <p className="text-gray-400">
                  You'll receive reminders on the selected days after solving
                  this problem. Complete them to track your review progress.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-gray-700 flex gap-2">
          ...
          >
            {saving
              ? "Setting Reminders..."
              : `Set ${selectedIntervals.length} Reminder${
